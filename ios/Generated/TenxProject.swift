...
public enum TenxProject {
    public static let projectAPIURL = resolvedURL("TENX_PROJECT_API_URL", fallback: "https://prj-13a2923d21134479.api.10x.app")
    public static let authBaseURL = resolvedURL("TENX_AUTH_BASE_URL", fallback: "https://prj-13a2923d21134479.api.10x.app/auth")
    public static let storageBaseURL = resolvedURL("TENX_STORAGE_BASE_URL", fallback: "https://prj-13a2923d21134479.api.10x.app/storage")
    public static let requestTimeoutInterval: TimeInterval = 20
public static let dataAPIURL: URL? = resolvedOptionalURL("TENX_DATA_API_URL", fallback: "https://ep-calm-dream-aw9piiov.apirest.c-12.us-east-1.aws.neon.tech/neondb/rest/v1")
